$(document).ready(function() {
	...
	Project Preview
	==============================================*/
	$('.project-item:not(.external-link)').on('click',function(e){
		e.preventDefault();
	...
	$('<style></style>').attr('id','switcher-styles').appendTo('head');	
	$('#switcher-styles').text('\
		#style-switcher {\
		  position:fixed;\
		  z-index:999;\
		  top:150px;\
	...
	$('body').append('<div id="style-switcher">\
		...
		<h1>Change Color</h1>\
		<ul class="clearfix">\
			<li id="color-1" style="background:#0C7ABF;"></li>\
			<li id="color-2" style="background:#F25454;"></li>\
			<li id="color-3" style="background:#00AB66;"></li>\
			<li id="color-4" style="background:#E5C41A;"></li>\
			<li id="color-5" style="background:#DF451A;"></li>\
			<li id="color-6" style="background:#8AD542;"></li>\
			<li id="color-7" style="background:#6B798F;"></li>\
			<li id="color-8" style="background:#6778C1;"></li>\
		</ul>\
		</div>');

	var colors = ['#0C7ABF','#F25454','#00AB66','#E5C41A','#DF451A','#8AD542','#6B798F','#6778C1'];
	...
	$('body').on('click','#style-switcher li',function(e){
		...
		$('#live-color').text('#toggle-switcher [class*=fa],a,a:hover,a:focus,.primary,#main-nav .nav .active > a,#main-nav .nav a:hover,.features .icon,.features .media:hover h4,.member-details .title,.project-item .hover-mask .fa:hover,.close-preview,.pricing .item .btn,.pricing .item.featured .btn:hover,#map-address:hover,#main-footer .social-links li:hover a,.modal-content .close:hover,.contact-item .icon,.btn.transparent,.btn.transparent:focus,.btn.white,.btn.white:focus,.btn.white.transparent:hover,.btn.white.transparent:active{	color:'+newColor+';}#page-loader span,.color-bg,.overlay-color:before,.team-member .member-socials li a:hover,#filter-works ul li.active a,#filter-works ul li:hover a,.project-item .hover-mask,#project-slider .flex-control-paging li a:hover,#project-slider .flex-control-paging li a.flex-active,.pricing .item.featured,.pricing .item .btn:hover,#main-footer .mc-newsletter .btn:hover,.btn,.btn:focus,.btn.transparent:hover,.btn.transparent:active,.btn.white:hover,.btn.white:active{	background:'+newColor+';}.features .icon {	border-bottom-color:'+newColor+';	border-right-color:'+newColor+';}#filter-works ul li.active a,#filter-works ul li:hover a,#project-slider .flex-control-paging li a,.btn.transparent,.btn.transparent:focus{	border-color:'+newColor+';}');
